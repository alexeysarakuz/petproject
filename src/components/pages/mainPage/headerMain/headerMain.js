      ...
      <div className="container">
        <div className="header__row">
          <Link to="/" className="header__categorie header__categorie-livingroom">
            ...
            <p>Make your living room stylish and comfortable with high quality living room furniture from Crate and Barrel.</p>
            <div>
