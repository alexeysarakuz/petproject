  ...
  <section className="posters-section">
    <div className="posters__col posters__col1">
      <Link to="/">
        ...
        <p>
          Eco-friendly, made of natural materials,
          furniture perfectly suiting any design and purposes.
        </p>
      </Link>
    </div>
    <div className="posters__col posters__col2">
      <Link to="/">
        ...
        <p>
          Stunning wooden furniture will greatly fit
          Loft style premises and classical interiors.
        </p>
      </Link>
    </div>
    <div className="posters__col posters__col3">
      <Link to="/">
        ...
        <p>
          New collection of Living room Furniture made
          of natural materials comes in various colors.
        </p>
      </Link>
    </div>
